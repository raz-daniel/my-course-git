...
const sentence = prompt(`Please Write Something!`);
const firstword = sentence.indexOf(` `);
const lastword = sentence.lastIndexOf(` ` + 1);
console.log(firstword)
console.log(lastword)
console.log(sentence.substring(0, firstword))
console.log(sentence.substring(lastword))
console.log(sentence.substring(0, firstword), sentence.substring(lastword))